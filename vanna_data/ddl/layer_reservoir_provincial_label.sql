...
-- Table comment: 省控水库注记
CREATE TABLE public."layer_reservoir_provincial_label" (
  ...
  "id" integer NOT NULL DEFAULT nextval('layer_reservoir_provincial_label_id_seq'::regclass)
);
