...
CREATE TABLE public."layer_entity_process" (
  "id" bigint NOT NULL,
  "process_type" character varying(100) DEFAULT 'industrial'::character varying,
  "layer_type" smallint DEFAULT 0,
  "layer_name_en" character varying(100) NOT NULL,
  "layer_name_cn" character varying(150),
  "geom_type" character varying(50),
  "layer_level" smallint DEFAULT 0,
  "query_expand_mark" smallint DEFAULT 0,
